...
# CORS settings
CORS_ALLOWED_ORIGINS_STR = config('CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://127.0.0.1:3000,https://misscultureglobalkenya.com,https://www.misscultureglobalkenya.com')
...
# CSRF settings
CSRF_TRUSTED_ORIGINS_STR = config('CSRF_TRUSTED_ORIGINS', default='http://localhost:3000,http://127.0.0.1:3000,https://misscultureglobalkenya.com,https://www.misscultureglobalkenya.com')
