...
class Ambassador(models.Model):
    ...
    profile_image = R2ImageField('profile_image', folder='missculture/ambassador', blank=True, null=True)
...
class KenyaGalleryPhoto(models.Model):
    ...
    image = R2ImageField('image', folder='missculture/kenya-gallery', blank=True, null=True)
...
class CulturalCommunity(models.Model):
    ...
    image = R2ImageField('image', folder='missculture/communities', blank=True, null=True)
...
class CulturalHeritage(models.Model):
    ...
    description = models.TextField()
    image = R2ImageField('image', folder='missculture/heritage', blank=True, null=True)
    audio_clip = R2FileField('audio_clip', folder='missculture/audio', resource_type='video', blank=True, null=True)
    video_clip = R2FileField('video_clip', folder='missculture/heritage-video', resource_type='video', blank=True, null=True)
...
class KenyaRegion(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField()
    image = R2ImageField('image', folder='missculture/regions', blank=True, null=True)
...
class Achievement(models.Model):
    ...
    description = models.TextField()
    image = R2ImageField('image', folder='missculture/achievements', blank=True, null=True)
...
class Partner(models.Model):
    ...
    logo = R2ImageField('logo', folder='missculture/partners', blank=True, null=True)
...
class TeamMember(models.Model):
    ...
    image = R2ImageField('image', folder='missculture/team', blank=True, null=True)
...
class SiteSettings(models.Model):
    ...
    logo_kenya = R2ImageField('logo_kenya', folder='missculture/logos', blank=True, null=True,
        help_text='Logo for Miss Culture Global Kenya (local franchise)')
    logo_global = R2ImageField('logo_global', folder='missculture/logos', blank=True, null=True,
        help_text='Logo for Miss Culture Global (parent organization)')
    mpesa_logo = R2ImageField('mpesa_logo', folder='missculture/logos', blank=True, null=True,
...
class AboutPageSettings(models.Model):
    ...
    hero_image = R2ImageField('hero', folder='missculture/pages/about', blank=True, null=True)
    mission_image = R2ImageField('mission', folder='missculture/pages/about', blank=True, null=True)
    ...
    leader_1_image = R2ImageField('leader_1', folder='missculture/pages/about/leaders', blank=True, null=True)
    ...
    leader_2_image = R2ImageField('leader_2', folder='missculture/pages/about/leaders', blank=True, null=True)
    ...
    leader_3_image = R2ImageField('leader_3', folder='missculture/pages/about/leaders', blank=True, null=True)
    ...
    leader_4_image = R2ImageField('leader_4', folder='missculture/pages/about/leaders', blank=True, null=True)
    ...
    leader_5_image = R2ImageField('leader_5', folder='missculture/pages/about/leaders', blank=True, null=True)
    ...
    leader_6_image = R2ImageField('leader_6', folder='missculture/pages/about/leaders', blank=True, null=True)
...
class HomePageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/home', blank=True, null=True)
    
    # Kenya Highlight Card (shown on homepage)
    kenya_highlight_image = R2ImageField('kenya_highlight', folder='missculture/pages/home/highlights', blank=True, null=True,
    ...
    ambassador_highlight_image = R2ImageField('ambassador_highlight', folder='missculture/pages/home/highlights', blank=True, null=True,
...
class KenyaPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/kenya', blank=True, null=True)
...
class AmbassadorPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/ambassador', blank=True, null=True)
    ...
    # Profile Section
    profile_image = R2ImageField('profile', folder='missculture/pages/ambassador', blank=True, null=True,
...
class EventsPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/events', blank=True, null=True)
...
class GalleryPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/gallery', blank=True, null=True)
...
class PartnershipPageSettings(models.Model):
    ...
    hero_image = R2ImageField('hero', folder='missculture/pages/partnership', blank=True, null=True)
...
class VotingPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/voting', blank=True, null=True)
    ...
    event_1_image = R2ImageField('event_1', folder='missculture/pages/voting/events', blank=True, null=True)
    event_2_image = R2ImageField('event_2', folder='missculture/pages/voting/events', blank=True, null=True)
    event_3_image = R2ImageField('event_3', folder='missculture/pages/voting/events', blank=True, null=True)
    event_4_image = R2ImageField('event_4', folder='missculture/pages/voting/events', blank=True, null=True)
    
    # Participant images for voting page
    participant_1_image = R2ImageField('participant_1', folder='missculture/pages/voting/participants', blank=True, null=True)
    participant_2_image = R2ImageField('participant_2', folder='missculture/pages/voting/participants', blank=True, null=True)
    participant_3_image = R2ImageField('participant_3', folder='missculture/pages/voting/participants', blank=True, null=True)
    participant_4_image = R2ImageField('participant_4', folder='missculture/pages/voting/participants', blank=True, null=True)
    participant_5_image = R2ImageField('participant_5', folder='missculture/pages/voting/participants', blank=True, null=True)
    participant_6_image = R2ImageField('participant_6', folder='missculture/pages/voting/participants', blank=True, null=True)
...
class ContactPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/contact', blank=True, null=True)
...
class FAQPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/faq', blank=True, null=True)
...
class ContributePageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/contribute', blank=True, null=True)
...
class PrivacyPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/privacy', blank=True, null=True)
...
class TermsPageSettings(models.Model):
    ...
    # Hero Section
    hero_image = R2ImageField('hero', folder='missculture/pages/terms', blank=True, null=True)
